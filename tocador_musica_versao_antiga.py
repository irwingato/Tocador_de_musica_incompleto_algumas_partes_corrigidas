...
def adicionar_musica():
    ...
    musica = musica.replace("C:/Users/Irwing Seiji Ato/Documents/IFPR/4º Semestre/Construção de Aplicações Orientada a Objetos/Trabalho 02 - Projeto da disciplina/mp3/audio/", "")
    musica = musica.replace(".mp3", "")
    # Adicionar ao fim da lista de reprodução
    lista_de_reproducao.insert(END, musica)
...
lista_de_reproducao = Listbox(quadro_principal, bg="black", fg="green", width=60, selectbackground="green", selectforeground="black")
...
# Nome temporário
meu_nome = Label(root, text='')
meu_nome.pack(pady=20)
